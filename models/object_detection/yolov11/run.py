...
ARCHITECTURE = "YOLO11"
ARCHITECTURE_CHECKPOINTS = ["YOLO11n", "YOLO11s", "YOLO11m", "YOLO11l", "YOLO11x"]
MODEL_DICT = {
    "yolo11n": {"model_name": "YOLO11n"},
    "yolo11s": {"model_name": "YOLO11s"},
    "yolo11m": {"model_name": "YOLO11m"},
    "yolo11l": {"model_name": "YOLO11l"},
    "yolo11x": {"model_name": "YOLO11x"},
}
